...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "/home/tamezza/HH-Analysis-bbbb/PostJetCalib/fastpostez/build/_deps/json-src"
...
execute_process(
  COMMAND "/cvmfs/sft.cern.ch/lcg/views/LCG_107a/x86_64-el9-gcc14-opt/bin/git" --git-dir=.git show-ref "v3.11.3"
  WORKING_DIRECTORY "/home/tamezza/HH-Analysis-bbbb/PostJetCalib/fastpostez/build/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/tamezza/HH-Analysis-bbbb/PostJetCalib/fastpostez/build/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tamezza/HH-Analysis-bbbb/PostJetCalib/fastpostez/build/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
